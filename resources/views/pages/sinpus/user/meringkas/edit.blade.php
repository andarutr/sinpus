...
@section('title', 'Edit Ringkasan Buku')
      ...
      <div class="col-lg-12 col-sm-9 col-12">
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab_block_1">
            <form action="/user/meringkas-buku/edit/{{ $book->url_book }}" method="POST">
              @csrf
              <div class="row gx-3">
                <div class="col-sm-12">
              ...
              <div class="title title-xs title-wth-divider text-primary text-uppercase my-4"><span>Edit Ringkasan Buku</span></div>
              <div class="row gx-3">
                <div class="col-sm-12">
                  <div class="form-group">
                    <label class="form-label">Text</label>
                    <textarea id="classic" name="ringkasan">{{ $ringkasan->ringkasan }}</textarea>
