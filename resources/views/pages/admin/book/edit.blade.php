...
<div class="container-xxl">
  ...
  <div class="hk-pg-header pt-7 pb-4">
    <h1 class="pg-title">Edit Buku</h1>
  </div>
  <!-- /Page Header -->
      ...
      <div class="col-lg-10 col-sm-9 col-10">
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab_block_1">
            <form action="/admin/book/edit/{{ $book->id_book }}" method="POST" enctype="multipart/form-data">@csrf
              <div class="row gx-3">
                <!-- If Sessions -->
                <div class="col-sm-6">
                	...
                	<div class="form-group">
                		<label class="form-label">Kategori</label>
	                  	<select class="form-select" name="category">
	                    	<option value="{{ $book->id_category }}">{{ $book->id_category }}</option>
