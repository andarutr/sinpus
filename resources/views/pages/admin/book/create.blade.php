...
@section('title', 'Posting Buku')

@section('content')
<div class="container-xxl">
  <!-- Page Header -->
  <div class="hk-pg-header pt-7 pb-4">
    <h1 class="pg-title">Posting Buku</h1>
  </div>
  <!-- /Page Header -->
      ...
      <div class="col-lg-10 col-sm-9 col-10">
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab_block_1">
            <form action="/admin/book/create" method="POST" enctype="multipart/form-data">@csrf
              <div class="row gx-3">
                <!-- If Sessions -->
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="form-label">Judul Buku</label>
                    <input class="form-control" type="text" name="nm_book" value="{{ old('nm_book') }}">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    @error('picture_book')<p class="text-danger">{{ $message }}</p>@enderror
                  </div>
                </div>
                <div class="col-sm-6">
                	<div class="form-group">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="author_book" value="{{ old('author_book') }}">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <textarea id="classic" name="description">{{ old('description') }}</textarea>
